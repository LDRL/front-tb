...
const Category = lazy(() => import("../Category/CategoryPage"))
const CategoryCreate = lazy(() => import("../Category").then(m => ({ default: m.CategoryCreate })))
const Brand = lazy(() => import("../Brand/BrandPage"))
